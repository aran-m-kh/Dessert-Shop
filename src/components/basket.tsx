...
const Basket = () => {
    ...
    if (cartItems.length === 0) {
        ...
        return <div className="mt-11 flex flex-col items-center bg-slate-100 bg-clip-padding rounded-md backdrop-filter backdrop-blur-sm bg-opacity-100 backdrop-saturate-50 backdrop-contrast-100">
        ...
        return <div className="h-fit  mt-11 mr-2 flex flex-col items-center bg-slate-100 bg-clip-padding rounded-md backdrop-filter backdrop-blur-sm bg-opacity-100 backdrop-saturate-50 backdrop-contrast-100">
            ...
            <div className="flex flex-row w-3/4 tab:justify-center my-4 items-center bg-slate-200 rounded-md p-2">
                ...
                <h3 className="m-1 text-sm">this is a <span className="font-bold">carbon-neutral</span> delivery</h3>
            </div>
