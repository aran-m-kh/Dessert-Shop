...
const Basket = () => {
    ...
    if (cartItems.length === 0) {
        ...
        return <div className="h-4/6 w-1/4 mt-11 mr-11 flex flex-col items-center bg-slate-100 bg-clip-padding rounded-md backdrop-filter backdrop-blur-sm bg-opacity-100 backdrop-saturate-50 backdrop-contrast-100">
        ...
        return <div className="h-fit w-1/4 mt-11 mr-11 flex flex-col items-center bg-slate-100 bg-clip-padding rounded-md backdrop-filter backdrop-blur-sm bg-opacity-100 backdrop-saturate-50 backdrop-contrast-100">
            ...
            <div className="flex flex-row my-4 items-center bg-slate-200 rounded-md p-2">
